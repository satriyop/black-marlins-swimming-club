...
function GoogleGlyph() {
  return (
    <svg viewBox="0 0 24 24" className="size-5" aria-hidden="true">
      ...
      <path fill="#34A853" d="M12 24c3.2 0 5.9-1 7.9-2.9l-4-3c-1.1.8-2.5 1.2-3.9 1.2-3 0-5.6-2-6.5-4.8H1.3v3.1C3.3 21.4 7.4 24 12 24z" />
      <path fill="#FBBC05" d="M5.5 14.5c-.2-.7-.4-1.4-.4-2.2s.1-1.5.4-2.2V7H1.3C.5 8.6 0 10.3 0 12.3c0 2 .5 3.7 1.3 5.3l4.2-3.1z" />
  ...
  return (
    <div className="grid min-h-dvh place-items-center bg-background px-6 text-foreground">
      <div className="flex flex-col items-center text-center">
        <img src="/images/crest.jpg" alt="Black Marlins Swimming Club" className="mb-4 size-20 rounded-full object-cover outline outline-1 -outline-offset-1 outline-white/15" />
...
export function LoginScreen() {
  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-background text-foreground">
      <img src="/images/pool.jpg" alt="" className="absolute inset-0 size-full object-cover opacity-40" />
      ...
      <div className="relative mx-auto flex min-h-dvh max-w-lg flex-col justify-center px-5 py-12">
        <div className="rise-in mb-8 flex flex-col items-center text-center">
          <img src="/images/crest.jpg" alt="Lambang Black Marlins Swimming Club" className="mb-5 size-28 rounded-full object-cover shadow-elevated outline outline-1 -outline-offset-1 outline-white/15" />
          <p className="text-xs font-semibold tracking-[0.28em] text-primary uppercase">Klaten · Jawa Tengah</p>
        ...
        <div className="rise-in rise-in-2 rounded-2xl border border-border bg-card/90 p-5 shadow-elevated backdrop-blur-sm">
          {authEnabled ? (
            <div className="grid gap-3">
              {google ? (
                <Button type="button" size="lg" className="w-full bg-foreground text-background hover:opacity-90" onClick={() => signIn(google.providerId, { callbackURL: "/" })}>
                  <GoogleGlyph />
                  Masuk dengan Google
                </Button>
              ) : null}
